    ...
    <div class="container-fluid d-flex otstup_block">
        ...
        <div class="row bg-white">
            ...
            <div class="col border rounded p-4">
                ...
                <div><h3>Эта страница выводит информацию о состоянии "Im feeling locky"</h3></div>
                ...
                <div class="row pt-5">
                    ...
                    <div v-else class="block-2">
                        ...
                        <div class="col-2"><h2>Результат 3-x последних нажатий:</h2></div>
                ...
                <div class="pt-4">
                    ...
                    <b-button variant="secondary" class="otstup" @click="HistoryLock()">History</b-button>

                    <i class="fa-solid fa-house fonawesome-icons"></i> <a :href="'/home/' + link" class="otstup">Вернуться
                    на главную</a>

                    <b-button variant="success" class="otstup" @click="GetRandom_integer_and_insert_DB()">im feeling
                        locky
                    </b-button>
...
export default {
    ...
    data() {
        return {
            result_lose_or_integer_after_save_feelLocky_in_DB: 'press button',
            tern_on_spiner_wait: '',
